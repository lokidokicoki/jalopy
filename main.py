...
def createEditVehicle(vehicle=None):
    ...
    questions = [
        ...
        },
        {
            ...
            'default': lambda x: vehicle['TYRE_SIZE_REAR'] if vehicle else x['TYRE_SIZE_FRONT'],
            'validate': lambda val: len(val) != 0 or 'Please supply a value'
        },
        {
            'type': 'input',
            ...
            'default': lambda x: str(vehicle['TYRE_PRESSURE_REAR']) if vehicle else x['TYRE_PRESSURE_FRONT'],
            'validate': lambda val: len(val) != 0 or 'Please supply a value'
        },
    ]
    ...
    questions = [
        {
            ...
            'choices': [
                {'name': i['DATE'], 'value': i['ID']} for i in allRecords
            ]
        }
    ]
